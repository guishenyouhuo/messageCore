...
<script type="text/javascript">
	$(function(){
		$("#srcUser").change(function(){
			...
			$.post("/message-helper/dividmsg/showDestUsers?srcUser=" + srcUserNum, function(data){
				 $("#appendDest").remove();
				 $("#trBtn").remove();
		...
		$("#trBtn").live('click', function(){
			...
			window.location.href="/message-helper/dividmsg/dividMessage?srcUser=" + srcUserNum + "&destUsers=" + destGsNums;
		});
	});
</script>
<body>
